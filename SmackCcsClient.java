...
public class SmackCcsClient {
	...
	static final String Message_Store = "message.txt";
	...
	public void handleIncomingDataMessage(Map<String, Object> jsonObject) {
		...
		if ("ECHO".equals(action)) {
			...
			String MSG_ID = getRandomMessageId();
			String message = createJsonMessage(toUserRegid, MSG_ID,
					payload, collapseKey, null, false);
			send(message);
			try{
			writeToMessageFile(MSG_ID, ""+payload);
			}catch(IOException e)
			{
				e.printStackTrace();
			}
	...
	public void writeToFile(String name, String regId) throws IOException {
		Map<String, String> regIdMap = readFromFile();
		System.out.println(">>>>>> entry in text file:==============================="+regIdMap.size());
...
//		out.println(name + "," + regId);
	...
	public void writeToMessageFile(String msgID, String msg) throws IOException {
		PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter(
				Message_Store, true)));
			out.println(msgID + "\t"  +msg);
		    out.close();
 ...
 public static void main(String [] args) {
    final String userName = "739759446881" + "@gcm.googleapis.com";
    final String password = "AIzaSyCN8SECFXNOH6rGxBqfa5QZj0OR-v9ux_c";
